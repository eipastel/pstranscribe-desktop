...
## Subtasks
- [ ] Chave segura no main: safeStorage + settings, IPC key:set/key:status/key:clear, validação /v1/models com erros 401/429/402 mapeados
- [ ] Porta de primeiro uso no widget: painel glass com Input + Salvar, estados checking/ok/error, PTT travado sem chave
